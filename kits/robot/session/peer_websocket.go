...
func (p *PeerWebsocket) OnTimeout(fn func(Peer) error) {
...
func (p *PeerWebsocket) CreateDataChannel(configuration webrtc.Configuration) (*DataChannel, error) {
...
// NewPeerWebsocket 创建
func NewPeerWebsocket(id string, conn *websocket.Conn, readDeadline, writeDeadline time.Duration, maxMessageSize int64, notifyChan chan struct{}) *PeerWebsocket {
	if maxMessageSize < 1 {
